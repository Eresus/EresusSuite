 ...
 * @version $Id: config.inc.php 547 2008-09-22 13:39:55Z mihalych $
...
$IMConfig['images_url'] = substr($_SERVER['REQUEST_URI'], 0, strpos($_SERVER['REQUEST_URI'], 'ext-3rd/xinha/')).'data/';
